...
<div class="wrapper">
  ...
  <ul class="menu-list">
    ...
    <li>
      <a class="bd-menu-link js-sublist-link has-sublist is-clicked is-open">
        <span class="bd-menu-link-name">Manage Your Team</span>
        <span class="icon is-small">
          <i class="fas fa-angle-right"></i>
        </span>
      </a>
      <ul class="bd-menu-sublist is-open">
        <li><a>Members</a></li>
        <li><a>Plugins</a></li>
